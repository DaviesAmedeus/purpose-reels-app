    ...
    <div class="page-header">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 text-right">
                <a href="{{ route('admin.posts', ['post_id'=>$post->id]) }}" class="btn btn-primary">View all posts</a>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="card card-box mb-2">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label for=""><b>Post meta key words</b>:<small>(Separated by comma.)</small></label>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-block mb-3" style="max-width: 250px;">
                            <img src="" alt="" class="img-thumbnail" id="featured_image_preview"
                                data-ijabo-default-img="{{ asset('images/posts/resized/resized_'.$post->featured_image) }}">
                        </div>
                        <div class="form-group">
