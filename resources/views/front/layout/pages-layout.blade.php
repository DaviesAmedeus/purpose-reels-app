        ...
        <div class="container">
            ...
            <nav class="navbar navbar-expand-lg navbar-white">
                <a class="navbar-brand" href="index.html">
                    <img class="img-fluid" width="150px" src="{{ asset('front/images/logo.png') }}" alt="SawaBlog">
                </a>
            ...
            <div class="row justify-content-between">
                <div class="col-md-3 mb-4">
                    <a class="mb-4 d-block" href="index.html">
                        <img class="img-fluid" width="150px" src="{{ asset('front/images/logo.png') }}"
                            alt="SawaBlog">
                    </a>
                    <p>Ratione illum tempore id voluptatem nemo fugit error nulla similique minima odit, pariatur eaque,
                        perspiciatis cumque necessitatibus voluptates nostrum magnam enim.</p>
                </div>
