                ...
                @if ($author->social_links)
                    ...
                    <div class="social-links mt-3">
                        ...
                        @if ($author->social_links->twitter_url)
                            <a href="{{ $author->social_links->twitter_url }}" target="_blank" title="X"><i
                                    class="ti-x"></i></a>
                        @endif
    ...
    <section class="section-sm mt-0 pt-4">
        <div class="container">
            <div class="row">
                ...
                @empty
                    <div class="col-12"><span class="text-danger text-center">No post found for this author!</span></div>
                @endforelse
