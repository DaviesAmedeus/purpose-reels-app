			...
			<div class="col-lg-8  mb-5 mb-lg-0">
				...
				<article class="row mb-5">
					<div class="col-12">
                     ...
                     <div class="slider-item">
                        <img loading="lazy" src="{{ asset('front/images/posts/11.png') }}" class="img-fluid" alt="post-thumb">
                        <div class="slider-content">
                           <h2 class="animate__animated">JavaScript ES6: Arrow Functions Explained</h2>
                        </div>
                     </div>
							<div class="slider-item">
                        <img loading="lazy" src="{{ asset('front/images/posts/02.png') }}" class="img-fluid" alt="post-thumb">
                        <div class="slider-content">
                           <h2 class="animate__animated">CSS Flexbox: Aligning Elements Like a Pro
							...
							<div class="slider-item">
                        <img loading="lazy" src="{{ asset('front/images/posts/03.png') }}" class="img-fluid" alt="post-thumb">
                        <div class="slider-content">
                ...
                <section id="home__latest-posts">
                    <article class="row mb-5">
                        <div class="col-md-4 mb-4 mb-md-0">
                            <div class="post-img-box">
                              <img src="{{ asset('front/images/posts/09.png') }}" class="img-fluid rounded-lg" alt="post-thumb">
                            </div>
                        </div>
                        <div class="col-md-8">
                            <h4>
                    ...
                    <article class="row mb-5">
                     <div class="col-md-4 mb-4 mb-md-0">
                         <div class="post-img-box">
                           <img src="{{ asset('front/images/posts/04.png') }}" class="img-fluid rounded-lg" alt="post-thumb"   >
                         </div>
                     </div>
                     <div class="col-md-8">
                         <h4>
                 ...
                 <article class="row mb-5">
                  <div class="col-md-4 mb-4 mb-md-0">
                      <div class="post-img-box">
                        <img src="{{ asset('front/images/posts/05.png') }}" class="img-fluid rounded-lg" alt="post-thumb"   >
                      </div>
                  </div>
                  <div class="col-md-8">
                      <h4>
